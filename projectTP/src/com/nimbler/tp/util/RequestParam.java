...
public class RequestParam {
	...
	public static final String  PLAN_JSON = "planJsonString";
	...
	public static final String FEEDBACK_FORMAT_TYPE = "formattype";
	public static final String RATING = "rating";
	public static final String TEXT_FEEDBACK = "txtfb";
	public static final String TYPE = "type";
	public static final String RAW_ADDRESS_TO = "rawAddTo";
	public static final String FORMATTED_ADDRESS_TO = "frmtdAddTo";
	public static final String GEO_RESPONSE_TO = "geoResTo";

	public static final String RAW_ADDRESS_FROM = "rawAddFrom";
	public static final String FORMATTED_ADDRESS_FROM = "frmtdAddFrom";
	public static final String GEO_RESPONSE_FROM = "geoResFrom";
	...
	public static final String LAT_TO = "latTo";
	public static final String LON_TO = "lonTo";

	public static final String LAT_FROM = "latFrom";
	public static final String LON_FROM = "lonFrom";

	public static final String TIME_FROM = "timeFrom";
	public static final String TIME_TO = "timeTo";
	public static final String TIME_TRIP_PLAN = "timeTripPlan";
